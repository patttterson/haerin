...
<header class="site-header" class:dev>
	<div class="site-header__inner">
		<a class="logo" href="#top"
			>no<span class="pct">%</span> <span class="logo-full">invitational</span></a
		>
		{#if dev}
		...
		<nav>
			...
			<a href="#info">info</a>
			<a href="#vods">vods</a>
			<a class="nav-icon" href={resolve('/discord')} aria-label="Tournament Discord">
...
<div class="page">
	<main>
		...
		<section class="section pt-0!" id="info">
			...
			<p class="discord-cta">
				interested? <a href={resolve('/discord')}>join the discord</a> to stay in the loop.
			</p>
		</section>
...
<style>
    ...
    */
	...
	.prize-row--1 {
		border-left: 3px solid var(--color-rank-gold);
	}
	.prize-row--2 {
		border-left: 3px solid var(--color-rank-silver);
	}
	.prize-row--3 {
		border-left: 3px solid var(--color-rank-bronze);
	}
	.prize-row--4 {
